...
Notes : il faut appliquer les formules de transformation pour trouver $\theta_1$ et $\theta_2$ \\
après avoir trouvé (X/Y)*2, $\theta_1$,$\theta_2$,$\rho_1$,$\rho_2$. \\
On doit les réinjecter la formules c1*c2 \\
...
Notes : il faut appliquer les formules de transformation pour trouver $\theta_1$ et $\theta_2$ \\
après avoir trouvé (X/Y)*2, $\theta_1$,$\theta_2$,$\rho_1$,$\rho_2$. \\
On doit les réinjecter la formules $\frac{c1}{c2}$ \\
